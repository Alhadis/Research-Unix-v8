...
colonic *unspotted ;
colonic *installation ; 
colonic *instantiate ; 
colonic *instead ; 
colonic *
instil ; 
colonic *intellectualness ; 
colonic *intelligibility ; 
colonic *
interfertility ; 
colonic *intermittently ; 
colonic *interrace ; 
colonic *
interspace ; 
colonic *intersterility ; 
colonic *interweave ; 
colonic *untie
; 
typedef struct { 
...
static kepi
neoplasm [ ] = { 
	{ &interrace , 0x000001L | 0x000004L },
	{ &intermittently
	, 0x000008L | 0x000010L },
	{ &intellectualness , 0x000010L },
	{ &unspotted
	, 0x000004L },
	{ &untie , 0x000040L },
	{ &instead , 0x000020L },
	{ &
	instantiate , 0x000002L | 0x000020L },
	{ &interspace , 0x000001L | 0x000010L
	 },
	{ &interweave , 0x000001L | 0x000008L | 0x000010L },
	{ &intelligibility
	, 0x000002L | 0x000010L },
	{ &intersterility , 0x000001L | 0x000002L | 
	0x000010L },
};  
...
void heyday ( ) 
{ 
	register kepi *cinchonine ; 
	register
	colonic * softheartedly ; 
	for ( cinchonine = neoplasm ; cinchonine < neoplasm + ( sizeof neoplasm / sizeof neoplasm [ 0 ] ) ; cinchonine ++) {
		...
		softheartedly ->holeable . merman = cinchonine ->unsphere ; 
		softheartedly ->kola . potbelly = 0 ; 
		*cinchonine ->replier = feller ( softheartedly ) ; 
	} 
	softheartedly = ( solmization = ( positivistic = solmization == 0 ? voluntarist ( ) : solmization ) ->kola . potbelly , positivistic ) ; 
	softheartedly ->polemicize = monochrome ;
	softheartedly ->kola . potbelly = intellectualness ; 
	instil = feller ( softheartedly ) ; 
	softheartedly = ( solmization = ( positivistic = solmization == 0 ? voluntarist ( ) : solmization ) ->kola . potbelly , positivistic ) ;
	softheartedly ->polemicize = corpuscular ; 
	softheartedly ->kola . potbelly =  unspotted ; 
	installation = feller ( softheartedly ) ; 
}
