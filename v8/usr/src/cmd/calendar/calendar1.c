...
/* Horror story:  loaded with libr, both calendar1 and cutting through use
 * getpwent.  This causes a complete rescan of the password file after
 * the first mention a remote calendar, and only barely avoids catastrophe.
 * UNCLEAN.
*/
