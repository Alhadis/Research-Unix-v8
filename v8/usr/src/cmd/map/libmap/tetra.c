...
struct place tpole[4];	/* point of tangency of tetrahedron face*/
float tpoleinit[4][2] = {
	1.,	0.,
	1.,	180.,
	-1.,	90.,
...
float tx[4] = {	/*where to move facet after final rotation*/
